...
// The dashboard content (system metrics, graphs, custom metrics cards),
// shared by the dashboard window and the tray hover popup.
public sealed class DashboardContentPanel : Panel
{
    ...
    public DashboardContentPanel(TrayAppContext context)
    {
    ...
    public void RefreshCustomMetrics()
    {
        ...
        var cardWidth = Math.Max(200, customMetricsPanel.ClientSize.Width - 24);
